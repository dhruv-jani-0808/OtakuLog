...
const AchievementModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _AchievementModeltypeEnumValueMap,
    ),
...
AchievementModel _achievementModelDeserialize(
  ...
  object.isarId = id;
  object.type =
      _AchievementModeltypeValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          AchievementTypeModel.firstAnimeCompleted;
...
P _achievementModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (_AchievementModeltypeValueEnumMap[
              reader.readByteOrNull(offset)] ??
          AchievementTypeModel.firstAnimeCompleted) as P;
    case 2:
...
const _AchievementModeltypeEnumValueMap = {
  'firstAnimeCompleted': 0,
  'firstMangaCompleted': 1,
  'episodesWatchedThreshold': 2,
  'chaptersReadThreshold': 3,
  'streakThreshold': 4,
  'animeLoggedThreshold': 5,
  'mangaLoggedThreshold': 6,
};
const _AchievementModeltypeValueEnumMap = {
  0: AchievementTypeModel.firstAnimeCompleted,
  1: AchievementTypeModel.firstMangaCompleted,
  2: AchievementTypeModel.episodesWatchedThreshold,
  3: AchievementTypeModel.chaptersReadThreshold,
  4: AchievementTypeModel.streakThreshold,
  5: AchievementTypeModel.animeLoggedThreshold,
  6: AchievementTypeModel.mangaLoggedThreshold,
};
...
extension AchievementModelByIndex on IsarCollection<AchievementModel> {
  ...
  Future<List<AchievementModel?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<AchievementModel?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(AchievementModel object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(AchievementModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<AchievementModel> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<AchievementModel> objects,
      {bool saveLinks = true}) {
...
extension AchievementModelQueryFilter
  ...
  QueryBuilder<AchievementModel, AchievementModel, QAfterFilterCondition>
      typeEqualTo(AchievementTypeModel value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'type',
        value: value,
  ...
  QueryBuilder<AchievementModel, AchievementModel, QAfterFilterCondition>
      typeBetween(
    AchievementTypeModel lower,
    AchievementTypeModel upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension AchievementModelQuerySortBy
  ...
  QueryBuilder<AchievementModel, AchievementModel, QAfterSortBy> sortById() {
    return QueryBuilder.apply(this, (query) {
...
extension AchievementModelQueryProperty
  ...
  QueryBuilder<AchievementModel, AchievementTypeModel, QQueryOperations>
      typeProperty() {
    return QueryBuilder.apply(this, (query) {
